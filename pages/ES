...
st.write('Running the example creates the surface plot of the Ackley function showing the vast number of local optima')
...
st.write('Develop a (mu, lambda)-ES')
...
seed(1)
# define range for input
bounds = asarray([[10.0, 1.0], [10.0, 1.0]])
